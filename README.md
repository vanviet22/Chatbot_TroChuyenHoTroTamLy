...
🚨 6. Cảnh báo khủng hoảng

Nhận diện tín hiệu tiêu cực (tự hại, nguy hiểm).

Cung cấp thông điệp cảnh báo & khuyến nghị liên hệ hỗ trợ chuyên nghiệp.
...
Tạo file .env (cùng cấp với main.py) và điền:
...
MYSQL_DB=chatbot_memory


Tham khảo file: .env_example

5. Khởi chạy Backend
python main.py


FastAPI server sẽ chạy tại:
